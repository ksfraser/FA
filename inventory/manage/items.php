...
function set_edit($stock_id)
{
	...
	$_POST['depreciation_rate'] = FormatService::numberFormat2($_POST['depreciation_rate'], 1);
	$_POST['depreciation_factor'] = FormatService::numberFormat2($_POST['depreciation_factor'], 1);
