...
$page_security = 'SA_ksf_customer_portal_admin';
$path_to_root="../..";

include($path_to_root . "/includes/session.inc");
add_access_extensions();
set_ext_domain('modules/ksf_customer_portal_admin');
...
//global $prefsDB;	//defined in class.ksf_customer_portal_admin.php
/*
...
//page("test");
	...
	include_once($path_to_root . "/modules/ksf_customer_portal_admin/class.ksf_customer_portal_admin.php");
	$coastc = new ksf_customer_portal_admin( "ksf_customer_portal_admin_prefs" );
	$found = $coastc->is_installed();
	$coastc->set_var( 'found', $found );
	$coastc->set_var( 'help_context', "Generate Catalogue" );
	$coastc->set_var( 'redirect_to', "ksf_customer_portal_admin.php" );
	$coastc->run();
