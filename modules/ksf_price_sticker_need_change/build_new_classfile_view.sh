...
class $1_view extends generic_fa_interface_view {
	...
	function usage_form()
	{
		...
		label_row( "Bug 3 - Configuration", "Config screen doesn't display any of the config variables.  As the only one this module has is DEBUG, this is very low priority as there is not any non EXCEPTION debugging code currently included" );
