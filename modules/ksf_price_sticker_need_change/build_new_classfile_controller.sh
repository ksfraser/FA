...
class $1 extends generic_fa_interface_controller {
	...
	function __construct( \$prefs )
	{
		...
		require_once( 'class.$1_view.php' );
		\$this->view = new $1_view( \$prefs, \$this );
		...
		\$this->add_submodules();
		require_once( 'class.$1_model.php' );
		\$this->model = new $1_model( $1_PREFS, \$this );	//defines the tabl
