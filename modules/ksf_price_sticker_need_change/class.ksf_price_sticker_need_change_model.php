...
require_once( 'class.ksf_price_sticker_need_change.inc.php' );
...
class ksf_price_sticker_need_change_model extends generic_fa_interface {
	...
	protected $loc_code;	
	function __construct( $prefs  = ksf_price_sticker_need_change_PREFS, $controller )
	{
	...
	******************************************************************************/
	function define_table()
	{
		...
		$this->table_interface->table_details['tablename'] = TB_PREF . 'ksf_price_sticker_need_change';
		...
		$this->table_interface->fields_array[] = array('name' => 'price', 'label' => 'Price', 'type' => 'double', 'null' => 'NOT NULL',  'readwrite' => 'readwrite');
		$this->table_interface->fields_array[] = array('name' => 'updated_b', 'label' => 'Price Tag Updated', 'type' => 'bool', 'null' => 'NOT NULL',  'readwrite' => 'readwrite');
		...
		$this->table_interface->fields_array[] = array('name' => 'loc_code', 'label' => 'Location Code', 'type' => $sidl, 'null' => 'NOT NULL',  'readwrite' => 'readwrite');
		//$this->table_interface->fields_array[] = array('name' => 'stock_id', 'label' => 'SKU', 'type' => $sidl, 'null' => 'NOT NULL',  'readwrite' => 'readwrite');

		$this->table_interface->table_details['index'][0]['type'] = 'unique';
		$this->table_interface->table_details['index'][0]['columns'] = "stock_id, loc_code, created_ts";
		$this->table_interface->table_details['index'][0]['keyname'] = "stock_id-loc_code-created_ts";
//
		$this->table_interface->table_details['index'][1]['type'] = 'unique';
		$this->table_interface->table_details['index'][1]['columns'] = "stock_id, price, loc_code";
		$this->table_interface->table_details['index'][1]['keyname'] = "stock_id-price-loc_code";
//
//		$this->table_interface->table_details['index'][0]['type'] = 'unique';
