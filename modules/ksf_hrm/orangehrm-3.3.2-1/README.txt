                    Bitnami OrangeHRM Stack 3.3.2-1
                  ==============================
...
The OrangeHRM Open Source system has an array of modules, all in one application
that fulfills your main HR requirements. You can download the OrangeHRM application
from our website and start using it with absolutely no cost or limitations. 

You can learn more about OrangeHRM at http://www.orangehrm.com

The Bitnami OrangeHRM Stack is an installer that greatly simplifies the
installation of OrangeHRM and runtime dependencies. It includes ready-to-run
versions of Apache, MySQL and PHP. OrangeHRM Stack is distributed for free
...
Bitnami OrangeHRM Stack ships with the following software versions:
...
To install Bitnami OrangeHRM Stack you will need:
...
The Bitnami OrangeHRM Stack is distributed as a binary executable installer.
...
bitnami-orangehrm-3.3.2-1-linux-installer.run on Linux or
bitnami-orangehrm-3.3.2-1-linux-x64-installer.run on Linux 64 bit or
bitnami-orangehrm-3.3.2-1-windows-installer.exe on Windows or
bitnami-orangehrm-3.3.2-1-osx-x64-installer.dmg on OS X x64.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-orangehrm-3.3.2-1-linux.run
...
Apache is 8080 on Linux or port 80 on Windows and for MySQL is 3306. If those 
...
'Installation Finished' page. You can choose to launch Bitnami OrangeHRM
Stack at this point. If you do so, your default web browser will open and
display the Welcome page for the Bitnami OrangeHRM Stack. 

If you received an error message during installation, please refer to
the Troubleshooting section.

The rest of this guide assumes that you installed Bitnami OrangeHRM
Stack in /home/user/orangehrm-3.3.2-1 on Linux or 
C:\Bitnami\orangehrm-3.3.2-1 or 
/Applications/orangehrm-3.3.2-1 on OS X and that 
you use port 8080 for Apache on Linux or port 80 on Windows and 3306 for MySQL. 

6. STARTING AND STOPPING BITNAMI ORANGEHRM STACK
...
On Windows, you can start and stop Bitnami OrangeHRM Stack using the shortcuts created
...
installation directory:
	...
	apps/
	  orangehrm/: OrangeHRM application folder
	    conf/: OrangeHRM Apache configuration files
	    htdocs/: OrangeHRM PHP application files
	  phpMyAdmin/: phpMyAdmin application folder (optional)

8. DEFAULT USERNAMES AND PASSWORDS

The OrangeHRM administrative user and password are the ones you set at
installation time. 

MySQL admin user is called 'root', and its password is the same as the
OrangeHRM administrative user password.
...
/home/user/orangehrm-3.3.2-1/apache2/logs/error.log on Linux or
C:\Program Files\Bitnami OrangeHRM Stack\apache2\logs\error.log on Windows or
/Applications/orangehrm-3.3.2-1/apache2/logs/error.log.
...
For any problem related to OrangeHRM, please visit 
http://forum.orangehrm.com/
...
OrangeHRM is distributed under the GNU General Public License v2,
which is located at
