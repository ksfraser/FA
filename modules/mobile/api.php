...
include_once ("includes/session-custom.inc");
...
include_once ($path_to_root . "/Zend/Json.php");
...
*				false - No log
*/
$log = new Log("mobile.log", $debugMode);
...
$user_alive = $_SESSION["wa_current_user"]->logged;
