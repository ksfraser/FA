...
require_once( 'class.ksf_sso.inc.php' );
...
class ksf_sso_model extends generic_fa_interface {
	...
	function __construct( $prefs  = ksf_sso_PREFS, $controller )
	{
	...
	******************************************************************************/
	function define_table()
	{
		...
		$this->table_interface->table_details['tablename'] = TB_PREF . 'ksf_sso';
