...
class $1_app extends application 
{
	function __construct()
	{
		global \$path_to_root;
		parent::__construct( $1, _(\$this->help_context = $2 ) );
		\$this->add_module( _( "Transactions" );
	        \$this->add_lapp_function(0, _('Transaction 1'), \$path_to_root.'/modules/$1/manage/transaction1.php?NewTransaction1=Yes', 'SA_$1_TRAN', MENU_TRANSACTION);
        	\$this->add_rapp_function(0, _('Transaction 2'), \$path_to_root.'/modules/$1/manage/transaction2.php?NewTransaction2=Yes', 'SA_$1_TRAN', MENU_TRANSACTION);

		\$this->add_module( _( "Inquiries and Reports" );
	        \$this->add_lapp_function(1, _('Report 1'), \$path_to_root.'/modules/$1/manage/report1.php?NewAction1=Yes', 'SA_$1_REP', MENU_INQUIRY);
        	\$this->add_rapp_function(1, _('Report 2'), \$path_to_root.'/modules/$1/manage/report2.php?NewAction2=Yes', 'SA_$1_REP', MENU_INQUIRY);

		\$this->add_module( _( "Maintenance" );
	        \$this->add_lapp_function(1, _('Maintenance 1'), \$path_to_root.'/modules/$1/manage/maintenance1.php?NewAction1=Yes', 'SA_$1_ADMIN', MENU_MAINTENANCE);
        	\$this->add_rapp_function(1, _('Maintenance 2'), \$path_to_root.'/modules/$1/manage/maintenance2.php?NewAction2=Yes', 'SA_$1_ADMIN', MENU_MAINTENANCE);
...
class hooks_$1 extends hooks {
	...
	*/
		...
		switch(\$app->id) {
			...
			case 'stock':
				\$app->add_rapp_function(2, _('$1'), 
				 'modules/$1/$1.php', 'SA_$1');	//example doesn't have \$path_to_root in from of mod_rel_path but this may then break!
		}
	}
	...
	function install_access()
	{
		...
		\$security_areas['SA_$1_ADMIN'] = array(SS_$1|101, _("$1"));
		\$security_areas['SA_$1_TRAN'] = array(SS_$1|101, _("$1"));
		\$security_areas['SA_$1_REP'] = array(SS_$1|101, _("$1"));
	...
	function db_prewrite(&\$cart, \$trans_type)
	{
		...
		//var_dump( \$cart );
		/*
		if( require_once( 'class.$1_model.php' ) )
		{
			\$model = new $1_model( $1_PREFS, \$this );
	...
	{
		\$app->add_application(new $1_app); // add menu tab defined by example_class
	}
	/*
	//
