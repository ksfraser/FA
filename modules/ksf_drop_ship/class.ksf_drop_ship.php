 ...
 * Provides:
        ...
        function form_ksf_drop_ship
        function form_ksf_drop_ship_completed
        function action_show_form()
        function install()
...
class ksf_drop_ship extends generic_fa_interface {
...
//		//$this->table_interface->table_details['foreign'][1] = array( 'column' => "stock_id", 'foreigntable' => "woo_prod_variable_master", "foreigncolumn" => "stock_id", "on_update" => "restrict", "on_delete" => "restrict" );
	...
	function form_ksf_drop_ship
	{
		$this->call_table( 'form_ksf_drop_ship_completed', "ksf_drop_ship" );
	}
	function form_ksf_drop_ship_completed
