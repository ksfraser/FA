...
class WC_API_Client {
	...
	public function build_api_url() {
		...
		// add WC API path
		$path .= '/wc-api/v3/';	//20160925 KSF was v2 but that doesn't support putting categories
					//One step further would be using the WP REST path instead of
					//the WOO one.
		//20170715 certain functions not working... using wp rest
		//$path .= '/wp-json/wc/v2';
