...
class WC_API_Client_Resource_Products extends WC_API_Client_Resource {
	 ...
	 * @return array|object your newly-created product
	 *
	 * Valid fields name, slug, type, order_by
	 */
	...
	public function create_categories( $cat )
	{
		$namespace = $this->object_namespace;
		$this->object_namespace = "product_category";
	...
	/*
		...
		$this->request_path = 'categories';
		$this->request_body = $cat;
	 */

		$ret = $this->do_request();
		$this->object_namespace = $namespace;
		return $ret;
	}
}
