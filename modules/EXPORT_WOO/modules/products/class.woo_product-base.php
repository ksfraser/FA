...
class woo_product_base extends woo_interface {
	...
	var $created_at;	//!<date-time S/V 	(date_created)	The date the product was created, in the site’s timezone.  read-only
	var $updated_at;	//!<date-time S/V 	(date_modified)	The date the product was last modified, in the site’s timezone.  read-only
	...
	var $virtual;		//!<boolean S/V 	If the product is virtual. Virtual products are intangible and aren’t shipped. Default is false.
