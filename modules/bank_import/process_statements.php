...
if (1) {
    ...
    $_POST['TransAfterDate'] = '01/01/2002';
...
if( isset( $_POST['TransAfterDate'] )
{
	$sql .= " WHERE t.valueTimestamp >= ".db_escape(date2sql($_POST['TransAfterDate'])).";
	if( isset( $_POST['TransToDate'] )
	{
		$sql .= " AND t.valueTimestamp <  ".db_escape(date2sql($_POST['TransToDate']));
	}
}
else if( isset( $_POST['TransToDate'] )
{
	$sql .= " WHERE t.valueTimestamp <  ".db_escape(date2sql($_POST['TransToDate']));
}
*/
/*
