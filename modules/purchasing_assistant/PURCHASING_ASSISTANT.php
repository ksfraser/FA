...
$page_security = 'SA_PURCHASING_ASSISTANT';
$path_to_root="../..";

include($path_to_root . "/includes/session.inc");
add_access_extensions();
set_ext_domain('modules/PURCHASING_ASSISTANT');

include_once($path_to_root . "/includes/ui.inc");
include_once($path_to_root . "/includes/data_checks.inc");
include_once($path_to_root . "/modules/PURCHASING_ASSISTANT/class.PURCHASING_ASSISTANT.php");
...
$prefsDB = "PURCHASING_ASSISTANT_prefs";
...
else
{
	...
	$coastc = new PURCHASING_ASSISTANT( "defiant.ksfraser.com", "fhs", "fhs", "fhs", "PURCHASING_ASSISTANT_prefs" );
	$found = $coastc->is_installed();
	$coastc->set_var( 'found', $found );
	$coastc->set_var( 'help_context', "Export to Woo Commerce Interface" );
	$coastc->set_var( 'redirect_to', "PURCHASING_ASSISTANT.php" );
	$coastc->run();
}
