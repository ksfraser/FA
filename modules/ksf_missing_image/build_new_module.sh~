...
//page("test");
	...
	include_once( \$path_to_root . "/modules/$1/class.$1.php");
...
. ./build_new_classfile_table.sh $1 $1 $1
		...
		switch(\$app->id) {
			...
			case 'stock':
				\$app->add_rapp_function(2, _('$1'), 
					\$path_to_root.'/modules/$1/$1.php', 'SA_$1');
		}
	}
...
cat > documentation.doxyfile << EOF
# Doxyfile 1.8.12
...
# specify the (relative or absolute) path into which the generated documentation will be written
OUTPUT_DIRECTORY       =

# If the CREATE_SUBDIRS tag is set to YES then doxygen will create 4096 sub directories (in 2 levels) 
# The default value is: NO.
CREATE_SUBDIRS         = YES

# If the ALLOW_UNICODE_NAMES tag is set to YES, doxygen will allow non-ASCIi characters to appear in the names of generated files.
# The default value is: NO.
...
# If the BRIEF_MEMBER_DESC tag is set to YES, doxygen will include brief member descriptions after the members that are listed in the file and class
...
# Set the OPTIMIZE_OUTPUT_JAVA tag to YES if your project consists of Java or Python sources only.
...
# classes, or namespaces to their corresponding documentation. 
...
# If the HIDE_SCOPE_NAMES tag is set to NO then doxygen will show members with their full class and namespace scopes in the documentation. 
# The default value is: NO.
HIDE_SCOPE_NAMES       = NO

# If the HIDE_COMPOUND_REFERENCE tag is set to NO (default) then doxygen will append additional text to a page's title, such as Class Reference. 
...
ECLIPSE_DOC_ID         = com.fraserhighlandshoppe.Project
