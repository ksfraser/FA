<?php
/*
define( 'ModName', 'ksf_expense_claims' );
define ('SS_' . ModName, 111<<8);
$ksf_expense_claims_prefsDB = ModName . "_prefs";
 */
define ('SS_ksf_expense_claims', 111<<8);
$ksf_expense_claims_prefsDB = "ksf_expense_claims_prefs";
 ...
 *
 * ***********************************************************************************/
class hooks_ksf_expense_claims extends hooks {
	...
	*/
		...
		switch($app->id) {
			...
			case 'stock':
				$app->add_rapp_function(2, _('Expense Claims'), 
					$path_to_root.'/modules/ksf_expense_claims/ksf_expense_claims.php', 'SA_ksf_expense_claims');
		}
	}

	function install_access()
	{
		$security_sections[SS_ksf_expense_claims] = _("Expense Claims");

		$security_areas['SA_ksf_expense_claims'] = array(SS_ksf_expense_claims|101, _("Expense Claims"));
	...
	{
		require_once( 'class.ksf_expense_claims.php' );
		$cl = new ksf_expense_claims( $ksf_expense_claims_prefsDB );
		$cl->module_install();
		return true;
	}
	 */
