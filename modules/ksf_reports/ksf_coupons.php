...
$page_security = 'SA_ksf_coupons';
$path_to_root="../..";

include($path_to_root . "/includes/session.inc");
add_access_extensions();
set_ext_domain('modules/ksf_coupons');

include_once($path_to_root . "/includes/ui.inc");
include_once($path_to_root . "/includes/data_checks.inc");
include_once($path_to_root . "/modules/ksf_coupons/class.ksf_coupons.php");
...
else
{
	...
	$ksf_coupons = new ksf_coupons( "defiant.ksfraser.com", "fhs", "fhs", "fhs", "ksf_coupons_prefs" );
	$found = $ksf_coupons->is_installed();
	$ksf_coupons->set_var( 'found', $found );
	$ksf_coupons->set_var( 'help_context', "ksf_coupons Interface" );
	$ksf_coupons->set_var( 'redirect_to', "ksf_coupons.php" );
	$ksf_coupons->run();
}
