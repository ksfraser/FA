<?php
/*
define( 'ModName', 'ksf_random_one_day_sale' );
define ('SS_' . ModName, 111<<8);
$ksf_random_one_day_sale_prefsDB = ModName . "_prefs";
 */
define ('SS_ksf_random_one_day_sale', 111<<8);
$ksf_random_one_day_sale_prefsDB = "ksf_random_one_day_sale_prefs";
 ...
 *
 * ***********************************************************************************/
class hooks_ksf_random_one_day_sale extends hooks {
	var $module_name = 'Random One Day Sale'; 
	...
	*/
	function install_options($app) {
		...
		switch($app->id) {
			...
			//case 'orders':
			case 'stock':
				$app->add_rapp_function(2, _('Random One Day Sale'), 
					$path_to_root.'/modules/ksf_random_one_day_sale/ksf_random_one_day_sale.php', 'SA_ksf_random_one_day_sale');
		}
	}

	function install_access()
	{
		$security_sections[SS_ksf_random_one_day_sale] = _("Random One Day Sale");

		$security_areas['SA_ksf_random_one_day_sale'] = array(SS_ksf_random_one_day_sale|101, _("Random One Day Sale"));
	...
	{
		require_once( 'class.ksf_random_one_day_sale.php' );
		$cl = new ksf_random_one_day_sale( $ksf_random_one_day_sale_prefsDB );
		$cl->module_install();
		return true;
	}
	 */
