<?php
/*
define( 'ModName', 'ksf_pear_mail_queue' );
define ('SS_' . ModName, 111<<8);
$ksf_pear_mail_queue_prefsDB = ModName . "_prefs";
 */
define ('SS_ksf_pear_mail_queue', 111<<8);
$ksf_pear_mail_queue_prefsDB = "ksf_pear_mail_queue_prefs";
 ...
 *
 * ***********************************************************************************/
class hooks_ksf_pear_mail_queue extends hooks {
	...
	*/
		...
		switch($app->id) {
			...
			case 'stock':
				$app->add_rapp_function(2, _('Quantity on Hand'), 
					$path_to_root.'/modules/ksf_pear_mail_queue/ksf_pear_mail_queue.php', 'SA_ksf_pear_mail_queue');
		}
	}

	function install_access()
	{
		$security_sections[SS_ksf_pear_mail_queue] = _("Quantity on Hand");

		$security_areas['SA_ksf_pear_mail_queue'] = array(SS_ksf_pear_mail_queue|101, _("Quantity on Hand"));
	...
	{
		require_once( 'class.ksf_pear_mail_queue.php' );
		$cl = new ksf_pear_mail_queue( $ksf_pear_mail_queue_prefsDB );
		$cl->module_install();
		return true;
	}
	 */
