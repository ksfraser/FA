...
require_once( 'class.SIC_xref_gl.inc.php' );
...
class SIC_xref_gl_model extends generic_fa_interface {
	var $id_SIC_xref_gl;	//!< Index of table
	//protected $class_specific_vars;

	function __construct( $prefs  = SIC_xref_gl_PREFS, $controller )
	{
	...
	******************************************************************************/
	function define_table()
	{
		...
		$this->table_interface->table_details['tablename'] = TB_PREF . 'SIC_xref_gl';
