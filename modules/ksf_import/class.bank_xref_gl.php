...
class bank_xref_gl extends generic_fa_interface_controller {
	...
	function __construct( $prefs )
	{
		...
		require_once( 'class.bank_xref_gl_view.php' );
		$this->view = new bank_xref_gl_view( $prefs, $this );
		...
		$this->add_submodules();
		require_once( 'class.bank_xref_gl_model.php' );
		$this->model = new bank_xref_gl_model( bank_xref_gl_PREFS, $this );	//defines the tabl
		$this->model->set( found, $this->get( found ) );

	}
	function run()
	{
		if( isset( $_POST['bank_xref_gl'] ) )
		{
