...
class qif_import extends woo_interface {
	var $id_qif_import;	//!< Index of table
...
//		//$this->table_details['foreign'][1] = array( 'column' => "stock_id", 'foreigntable' => "woo_prod_variable_master", "foreigncolumn" => "stock_id", "on_update" => "restrict", "on_delete" => "restrict" );
	...
	function form_qif_import
	{
		$this->call_table( 'form_qif_import_completed', "QIF_Import" );
	}
	function form_qif_import_completed
