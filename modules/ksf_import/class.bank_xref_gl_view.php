 ...
 * Provides:
        ...
        function form_bank_xref_gl
        function form_bank_xref_gl_completed
        function action_show_form()
        function install()
...
class bank_xref_gl_view extends generic_fa_interface_view {
	var $id_bank_xref_gl;	//!< Index of table
	function __construct( $prefs,  )
	{
		...
		$this->tabs[] = array( 'title' => 'bank_xref_gl Updated', 'action' => 'form_bank_xref_gl_completed', 'form' => 'form_bank_xref_gl_completed', 'hidden' => TRUE );
		$this->tabs[] = array( 'title' => 'Update bank_xref_gl', 'action' => 'form_bank_xref_gl', 'form' => 'form_bank_xref_gl', 'hidden' => FALSE );
	...
	function usage_form()
	{
		...
		label_row( "bank_xref_gl", "This tab is where you XYZ" );
	...
	function form_bank_xref_gl
	{
		$this->call_table( 'form_bank_xref_gl_completed', "Associate a downloaded bank account number to a destination GL" );
	}
	function form_bank_xref_gl_completed
