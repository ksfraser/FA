...
require_once( 'class.bank_xref_gl.inc.php' );
...
class bank_xref_gl_model extends generic_fa_interface {
	var $id_bank_xref_gl;	//!< Index of table
	//protected $class_specific_vars;

	function __construct( $prefs  = bank_xref_gl_PREFS, $controller )
	{
	...
	******************************************************************************/
	function define_table()
	{
		...
		$this->table_interface->table_details['tablename'] = TB_PREF . 'bank_xref_gl';
