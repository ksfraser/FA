...
class ksf_import_ofx_view extends generic_fa_interface_view {
	...
	function __construct( $prefs,  )
	{
		...
		$this->tabs[] = array( 'title' => 'ksf_import_ofx Updated', 'action' => 'form_ksf_import_ofx_completed', 'form' => 'form_ksf_import_ofx_completed', 'hidden' => TRUE );
		$this->tabs[] = array( 'title' => 'Update ksf_import_ofx', 'action' => 'form_ksf_import_ofx', 'form' => 'form_ksf_import_ofx', 'hidden' => FALSE );
	...
	function usage_form()
	{
		...
		label_row( "ksf_import_ofx", "This tab is where you XYZ" );
	...
	function form_ksf_import_ofx
	{
		$this->call_table( 'form_ksf_import_ofx_completed', "Import OFX files into Staging" );
	}
	function form_ksf_import_ofx_completed
	...
	function item_form()
	{
		display_heading(ksf_import_ofx);
