...
require_once( 'class.ksf_import.inc.php' );
...
class ksf_import_model extends generic_fa_interface {
	var $id_ksf_import;	//!< Index of table
	//protected $class_specific_vars;

	function __construct( $prefs  = ksf_import_PREFS, $controller )
	{
	...
	******************************************************************************/
	function define_table()
	{
		...
		$this->table_interface->table_details['tablename'] = TB_PREF . 'ksf_import';
