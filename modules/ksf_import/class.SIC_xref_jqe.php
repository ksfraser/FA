...
class SIC_xref_jqe extends generic_fa_interface_controller {
	...
	function __construct( $prefs )
	{
		...
		require_once( 'class.SIC_xref_jqe_view.php' );
		$this->view = new SIC_xref_jqe_view( $prefs, $this );
		...
		$this->add_submodules();
		require_once( 'class.SIC_xref_jqe_model.php' );
		$this->model = new SIC_xref_jqe_model( SIC_xref_jqe_PREFS, $this );	//defines the tabl
		$this->model->set( found, $this->get( found ) );

	}
	function run()
	{
		if( isset( $_POST['SIC_xref_jqe'] ) )
		{
