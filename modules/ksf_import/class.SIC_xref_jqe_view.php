 ...
 * Provides:
        ...
        function form_SIC_xref_jqe
        function form_SIC_xref_jqe_completed
        function action_show_form()
        function install()
...
class SIC_xref_jqe_view extends generic_fa_interface_view {
	...
	function __construct( $prefs,  )
	{
		...
		$this->tabs[] = array( 'title' => 'SIC_xref_jqe Updated', 'action' => 'form_SIC_xref_jqe_completed', 'form' => 'form_SIC_xref_jqe_completed', 'hidden' => TRUE );
		$this->tabs[] = array( 'title' => 'Update SIC_xref_jqe', 'action' => 'form_SIC_xref_jqe', 'form' => 'form_SIC_xref_jqe', 'hidden' => FALSE );
	...
	function usage_form()
	{
		...
		label_row( "SIC_xref_jqe", "This tab is where you XYZ" );
	...
	function form_SIC_xref_jqe
	{
		$this->call_table( 'form_SIC_xref_jqe_completed', "Associate a downloaded vendor SIC number to a Journal Quick Entry" );
	}
	function form_SIC_xref_jqe_completed
