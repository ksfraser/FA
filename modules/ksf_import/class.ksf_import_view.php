 ...
 * Provides:
        ...
        function form_ksf_import
        function form_ksf_import_completed
        function action_show_form()
        function install()
...
class ksf_import_view extends generic_fa_interface_view {
	var $id_ksf_import;	//!< Index of table
	function __construct( $prefs,  )
	{
		...
		$this->tabs[] = array( 'title' => 'ksf_import Updated', 'action' => 'form_ksf_import_completed', 'form' => 'form_ksf_import_completed', 'hidden' => TRUE );
		$this->tabs[] = array( 'title' => 'Update ksf_import', 'action' => 'form_ksf_import', 'form' => 'form_ksf_import', 'hidden' => FALSE );
	...
	function usage_form()
	{
		...
		label_row( "ksf_import", "This tab is where you XYZ" );
	...
	function form_ksf_import
	{
		$this->call_table( 'form_ksf_import_completed', "ksf_import" );
	}
	function form_ksf_import_completed
