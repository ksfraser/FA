...
class ksf_import extends generic_fa_interface_controller {
	...
	function __construct( $prefs )
	{
		...
		require_once( 'class.ksf_import_view.php' );
		$this->view = new ksf_import_view( $prefs, $this );
		...
		$this->add_submodules();
		require_once( 'class.ksf_import_model.php' );
		$this->model = new ksf_import_model( ksf_import_PREFS, $this );	//defines the tabl
		$this->model->set( found, $this->get( found ) );

	}
	function run()
	{
		if( isset( $_POST['ksf_import'] ) )
		{
