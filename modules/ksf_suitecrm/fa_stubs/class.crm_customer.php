...
class crm_customer extends generic_fa_interface {
	var $id_crm_customer;	//!< Index of table
...
//		//$this->table_details['foreign'][1] = array( 'column' => "stock_id", 'foreigntable' => "woo_prod_variable_master", "foreigncolumn" => "stock_id", "on_update" => "restrict", "on_delete" => "restrict" );
	...
	function form_crm_customer
	{
		$this->call_table( 'form_crm_customer_completed', "crm_customer" );
	}
	function form_crm_customer_completed
