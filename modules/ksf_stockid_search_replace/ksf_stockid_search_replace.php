<?php
/**********************************************
Name: Stock_ID Search and Replace
modified for COAST 1.5.1 and FrontAccounting 2.3.15 by kfraser 
Free software under GNU GPL
***********************************************/

$page_security = 'SA_ksf_stockid_search_replace';
$path_to_root="../..";

include($path_to_root . "/includes/session.inc");
add_access_extensions();
set_ext_domain('modules/ksf_stockid_search_replace');
...
//global $prefsDB;	//defined in class.ksf_stockid_search_replace.php
/*
...
//page("test");
	...
	include_once($path_to_root . "/modules/ksf_stockid_search_replace/class.ksf_stockid_search_replace.php");
	require_once( 'ksf_stockid_search_replace.inc.php' );
	$coastc = new ksf_stockid_search_replace( KSF_QOH_PREFS );
	$found = $coastc->is_installed();
	$coastc->set_var( 'found', $found );
	$coastc->set_var( 'help_context', "Stock_ID Search and Replace" );
	$coastc->set_var( 'redirect_to', "ksf_stockid_search_replace.php" );
	$coastc->run();
