<?php
/*
define( 'ModName', 'ksf_stockid_search_replace' );
define ('SS_' . ModName, 111<<8);
$ksf_stockid_search_replace_prefsDB = ModName . "_prefs";
 */
define ('SS_ksf_stockid_search_replace', 111<<8);
$ksf_stockid_search_replace_prefsDB = "ksf_stockid_search_replace_prefs";
 ...
 *
 * ***********************************************************************************/
class hooks_ksf_stockid_search_replace extends hooks {
	var $module_name = 'Replace Stock_id'; 
	...
	*/
	function install_options($app) {
		...
		switch($app->id) {
			...
			//case 'orders':
			//case 'stock':
				$app->add_lapp_function(2, _('Replace Stock_id'), 
					$path_to_root.'/modules/ksf_stockid_search_replace/ksf_stockid_search_replace.php', 'SA_ksf_stockid_search_replace');
		}
	}

	function install_access()
	{
		$security_sections[SS_ksf_stockid_search_replace] = _("Replace Stock_id");

		$security_areas['SA_ksf_stockid_search_replace'] = array(SS_ksf_stockid_search_replace|101, _("Replace Stock_id"));
	...
	{
		require_once( 'class.ksf_stockid_search_replace.php' );
		$cl = new ksf_stockid_search_replace( $ksf_stockid_search_replace_prefsDB );
		$cl->module_install();
		return true;
	}
	 */
