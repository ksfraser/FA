...
$page_security = 'SA_ksf_expense_claims';
$path_to_root="../..";

include($path_to_root . "/includes/session.inc");
add_access_extensions();
set_ext_domain('modules/ksf_expense_claims');
...
//global $prefsDB;	//defined in class.ksf_expense_claims.php
/*
...
//page("test");
	...
	include_once($path_to_root . "/modules/ksf_expense_claims/class.ksf_expense_claims.php");
	$coastc = new ksf_expense_claims( "ksf_expense_claims_prefs" );
	$found = $coastc->is_installed();
	$coastc->set_var( 'found', $found );
	$coastc->set_var( 'help_context', "Generate Catalogue" );
	$coastc->set_var( 'redirect_to', "ksf_expense_claims.php" );
	$coastc->run();
